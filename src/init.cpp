...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/creativechain/creativechain-core>";
    const std::string URL_WEBSITE = "<https://creativechain.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("creativecoin-loadblk");
    CImportingNow imp;
