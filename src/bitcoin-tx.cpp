...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s creativecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  creativecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded creativecoin transaction") + "\n" +
              "  creativecoin-tx [options] -create [commands]   " + _("Create hex-encoded creativecoin transaction") + "\n" +
              "\n";
