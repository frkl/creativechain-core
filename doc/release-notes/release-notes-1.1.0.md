Creativecoin Core version 1.1.0 is now available from:
...
* **Keccak-256** has been implemented as a new **PoW algorithm**. This change will be 
effective from block 46368 on the Mainnet network, and block 720 on the Testnet network.

* **DigiShield** has been implemented as a new difficulty calculation algorithm. 
This new implementation will calculate the difficulty in each mined block, resulting in 
a new more dynamic retargeting system that makes the network more robust against certain 
attacks. This change will be effective from block 46368 on the Mainnet network, and block 
720 on the Testnet network.

* **The TestNet** has been released and ready for use. Add this node using terminal:
     `creativecoin-cli addnode 5.189.152.67 add`
     
* [Creativecoin Testnet Pool](https://testnet-pool.creativecoin.tk/)
...
(in Creativecoin Core 0.10.3) it has been disabled by default.
...
Creativecoin Core has supported automatically pruning the blockchain since 0.11. Pruning
...
The Alert System was [disabled and deprecated](https://bitcoin.org/en/alert/2016-11-01-alert-retirement) in Creativecoin Core 0.12.1 and removed in 0.13.0. 
